...
export default function Home() {
    ...
    const handleAnswersProvided = async (answers: Array<{ question: string; answer: string }>) => {
        ...
        try {
            ...
            // Resolve context
            const resolvedContext = await projectContextService.resolveContext(
                currentInput.project_id,
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-6">
                        {clarifyingQuestions.length > 0 ? (
                            ...
                            <SpecOutputDisplay output={specOutput} summary={summary} loading={loading} />
                        )}
                    </div>
                </div>
            </div>
