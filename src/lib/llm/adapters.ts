...
export abstract class LLMAdapter {
    ...
    abstract generateCompletion(messages: LLMMessage[], options?: LLMRequestOptions): Promise<LLMResponse>;
...
export class OpenAIAdapter extends LLMAdapter {
    ...
    async generateCompletion(messages: LLMMessage[], options: LLMRequestOptions = {}): Promise<LLMResponse> {
        const {
            temperature = 0.1,
            max_tokens = 4000,
            timeout = 60000,
        ...
        const requestBody: LLMRequestOptions = {
...
export class AnthropicAdapter extends LLMAdapter {
    ...
    async generateCompletion(messages: LLMMessage[], options: LLMRequestOptions = {}): Promise<LLMResponse> {
        const { temperature = 0.1, max_tokens = 4000, timeout = 60000, top_p } = options;
...
export class OllamaAdapter extends LLMAdapter {
    ...
    async generateCompletion(messages: LLMMessage[], options: LLMRequestOptions = {}): Promise<LLMResponse> {
        const { temperature = 0.1, timeout = 60000 } = options;
