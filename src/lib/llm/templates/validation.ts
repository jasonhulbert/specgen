 ...
 */
export function validateTemplateContext(templateName: string, context: TemplateContext): {
  valid: boolean
 ...
 */
export function testTemplateRender(templateName: string, context?: TemplateContext): {
  success: boolean
  result?: string
  error?: string
} {
