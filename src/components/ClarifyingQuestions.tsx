        ...
        <Card>
            <CardHeader>
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <p>
                        Please answer these questions to improve the specification quality. You can skip questions
            ...
            <CardContent className="space-y-6">
                {questions.map((question, index) => (
                    <div key={index} className="space-y-3">
                        <div className="bg-blue-50 border border-blue-200 p-4 rounded-md">
                            <div className="font-medium text-blue-800 mb-1">{question.topic}</div>
                            <div className="text-blue-700 mb-2">{question.question}</div>
                ...
                <div className="flex gap-2 pt-4 border-t">
                    <Button onClick={handleSubmit} disabled={!canSubmit || loading} className="flex-1">
                        {loading
                            ? 'Generating Refined Spec...'
                            : `Generate Spec with ${answeredCount} Answer${answeredCount !== 1 ? 's' : ''}`}
                    </Button>
                ...
                <div className="text-xs text-muted-foreground">
                    <strong>Tip:</strong> Answering more questions will result in a more accurate and complete
                    specification.
                </div>
            </CardContent>
        </Card>
