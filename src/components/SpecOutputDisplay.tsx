                    ...
                    <TabsContent value="summary" isActive={activeTab === 'summary'}>
                        <div className="prose prose-sm max-w-none">
                            ...
                            <div className="bg-muted p-4 rounded-md">
                                <div>
                                    <strong>Complexity:</strong> {output.estimation.complexity}
                                </div>
                                <div>
                                    <strong>Confidence:</strong> {Math.round(output.estimation.confidence * 100)}%
                                </div>
                                <div>
                                    <strong>Drivers:</strong> {output.estimation.drivers.join(', ')}
                                </div>
                                {output.estimation.notes && (
                                    <div>
                                        <strong>Notes:</strong> {output.estimation.notes}
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    <TabsContent value="story" isActive={activeTab === 'story'}>
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="bg-muted p-4 rounded-md">
                                    <div>
                                        <strong>As a</strong> {output.story.as_a}
                                    </div>
                                    <div>
                                        <strong>I want</strong> {output.story.i_want}
                                    </div>
                                    <div>
                                        <strong>So that</strong> {output.story.so_that}
                                    </div>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        {output.needs_clarification.map((item, index) => (
                                            <div
                                                key={index}
                                                className="bg-orange-50 border border-orange-200 p-4 rounded-md"
                                            >
                                ...
                                {Object.keys(output.resolved_context.glossary).length > 0 && (
                                    <div>
                                        ...
                                        <div className="bg-muted p-4 rounded-md space-y-2">
                                            {Object.entries(output.resolved_context.glossary).map(
                                                ([term, definition]) => (
                                                    <div key={term}>
